...
class repubber():
    ...
    def callback(self, a,c):
        if self.repubber:
            ...
            con = np.concatenate((frame1, frame3), axis=1)
            ...
            print("publishing with pubber13")
    ...
    def listener(self):
        ...
        ts = message_filters.ApproximateTimeSynchronizer([image1_sub,image3_sub],10,0.1)
...
if __name__ == "__main__":
    rospy.init_node('usb_cam_pub_13', anonymous=False, disable_signals=True)
    rate = rospy.Rate(10)
    try:
        t = repubber()
        t.main()
