...
class repubber():
    ...
    def callback(self, a,b):
        if self.repubber:
            ...
            print("publishing with pubber12")
    ...
    def listener(self):
        ...
        ts = message_filters.ApproximateTimeSynchronizer([image1_sub,image2_sub],10,0.1)
...
if __name__ == "__main__":
    rospy.init_node('usb_cam_pub_12', anonymous=False, disable_signals=True)
    rate = rospy.Rate(10)
    try:
        t = repubber()
        t.main()
